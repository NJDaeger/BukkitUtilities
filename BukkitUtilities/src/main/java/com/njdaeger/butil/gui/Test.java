...
public class Test {
    ...
    public void test() {
        ...
        BasicGui g = new BasicGui(/*plugin*/);
        ...
        IncrementalButton<Player> size = new IncrementalButton<>(2, 4, (p) -> new ItemStack(Material.ACACIA_BOAT));
        size.onDecrement((p, b) -> {
            if (b.getSlot() == 1) b.setSlot(1);
        });
