...
public abstract class AbstractFlag<A extends ParsedType<?>> {
    ...
    private AbstractFlag(char flagCharacter, Character splitter, boolean followingValue) {
    ...
    public AbstractFlag(char flagCharacter, Character splitter) {
     ...
     */
    public AbstractFlag(char flagCharacter, boolean followingValue) {
     ...
     * @param flagCharacter The character to proceed the dash.
     */
    public AbstractFlag(char flagCharacter) {
